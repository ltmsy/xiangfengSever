...
CREATE TABLE `admin_system_config` (
  ...
  `config_type` varchar(50) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'string' COMMENT '配置类型：string、number、boolean、json等',
...
('system.site_logo', '/assets/images/logo.png', 'string', '网站Logo路径', 'system', 1, 1, 201, 1, 'system', 'system'),
('system.site_favicon', '/assets/images/favicon.ico', 'string', '网站图标路径', 'system', 1, 1, 202, 1, 'system', 'system'),
('system.default_avatar', '/assets/images/default_avatar.png', 'string', '默认用户头像', 'system', 1, 1, 203, 1, 'system', 'system'),
('system.default_group_avatar', '/assets/images/default_group_avatar.png', 'string', '默认群组头像', 'system', 1, 1, 204, 1, 'system', 'system'),
